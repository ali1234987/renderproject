...
export const Navbar = () => {
  ...
  <div className="absolute top-8 left-0 w-48 bg-white border border-slate-200 rounded-lg shadow-lg py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
    <Link to="/location/london" className="block px-4 py-2 text-sm text-slate-600 hover:bg-emerald-50 hover:text-emerald-600">
      London
    </Link>

    <Link to="/location/manchester" className="block px-4 py-2 text-sm text-slate-600 hover:bg-emerald-50 hover:text-emerald-600">
      Manchester
    </Link>

    <Link to="/location/birmingham" className="block px-4 py-2 text-sm text-slate-600 hover:bg-emerald-50 hover:text-emerald-600">
      Birmingham
    </Link>
  </div>
</div>
          ...
          <div className="border-b border-slate-50">
            ...
            {locationOpen && (
              <div className="pl-6 pb-2">
                <Link to="/location/london" className="block py-2 text-sm text-slate-600 hover:text-emerald-600">
                  London
                </Link>
                <Link to="/location/manchester" className="block py-2 text-sm text-slate-600 hover:text-emerald-600">
                  Manchester
                </Link>
                <Link to="/location/birmingham" className="block py-2 text-sm text-slate-600 hover:text-emerald-600">
                  Birmingham
                </Link>
              </div>
            )}
